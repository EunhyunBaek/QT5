...
#include "../../Date_18_7_27_QWidget_Event/thread.h"
...
QT_MOC_LITERAL(3, 17, 10), // "stopThread"
QT_MOC_LITERAL(4, 28, 12) // "resumeThread"

    },
    "Thread\0setLabel\0\0stopThread\0resumeThread"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::setLabel)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread::setLabel(QString _t1)
{
